...
fn test_filter() {
    ...
    let update_systems = [
        ...
        world.register_system(systems::EnumFilterSystems::remove_marker_for_enum::<TestEnum>),
        world.register_system(systems::EnumFilterSystems::watch_for_enum::<TestEnum>),
    ];

    let entity = world.spawn(TestEnum::A).id();

    [world.register_system(systems::EnumFilterSystems::create_marker_for_enum::<TestEnum>)]
        .into_iter()
